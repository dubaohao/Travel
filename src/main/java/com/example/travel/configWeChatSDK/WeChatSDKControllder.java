...
@CrossOrigin
@Controller
@RequestMapping("/wechatSDK")
@Slf4j
public class WeChatSDKControllder {

    private WxPayService wxService;

    @Autowired
    public WeChatSDKControllder(WxPayService wxService) {
     ...
     */
    //dubaohao-@ApiOperation(value = "查询订单")
     ...
     */
    //dubaohao-@ApiOperation(value = "关闭订单")
     ...
     */
    //dubaohao-@ApiOperation(value = "统一下单，并组装所需支付参数")
     ...
     */
    //dubaohao-@ApiOperation(value = "原生的统一下单接口")
     ...
     * @return 退款操作结果
     */
    //dubaohao-@ApiOperation(value = "退款")
    @PostMapping("/refund")
     ...
     * @return 退款信息
     */
    //dubaohao-@ApiOperation(value = "退款查询")
    ...
    //dubaohao-@ApiOperation(value = "支付回调通知处理")
    ...
    //dubaohao-@ApiOperation(value = "退款回调通知处理")
    ...
    //dubaohao-@ApiOperation(value = "扫码支付回调通知处理")
     ...
     * @param request 请求对象
     */
    //dubaohao-@ApiOperation(value = "发送红包")
     ...
     */
    //dubaohao-@ApiOperation(value = "查询红包")
     ...
     * </pre>
     */
    //dubaohao-@ApiOperation(value = "提交交易保障数据")
    @PostMapping("/report")
     ...
     * @return 保存到本地的临时文件
     */
    //dubaohao-@ApiOperation(value = "下载对账单")
     ...
     * </pre>
     */
    //dubaohao-@ApiOperation(value = "提交刷卡支付")
     ...
     * </pre>
     */
    //dubaohao-@ApiOperation(value = "撤销订单")
    ...
    //dubaohao-@ApiOperation(value = "查询代金券批次")
    ...
    //dubaohao-@ApiOperation(value = "查询代金券信息")
    ...
    //dubaohao-@ApiOperation(value = "拉取订单评价数据")
